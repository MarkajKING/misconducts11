...
<div role="listitem" class="relative mt-16 mb-32 lg:w-4/5">
    <div class="rounded overflow-hidden shadow-md bg-white dark:bg-gray-900">
        ...
        <div class="px-6 mt-16" style="min-height:500px">
            ...
            <p class="text-gray-800 dark:text-white text-sm text-center pt-0 mt-0">Talen: {{ $confidant->language }}</p>
            <p class="text-yellow-800 dark:text-white text-sm text-center pt-0 mt-0">{{ $confidant->speciality }}</p>
