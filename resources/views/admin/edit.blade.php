...
<x-layout>
    ...
    <section class="py-8 max-w-7xl mx-auto">
        ...
        <h1 class="text-lg font-bold text-4xl text-blue-500 mt-10 ">Hallo, </h1>
        ...
        <div class="container mt-5 p-5 bg-light rounded shadow-sm">
            <div class="row">
                ...
                <div class="col">
                    <form method="POST" action="/admin/mijn-account/{{ $confidant->id }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="mb-6">
                            ...
                            <input class="border border-gray-400 p-2 w-full rounded"
                                   ...
                                   name="photo"
                                   id="photo"
                                   value="{{ old('photo', $confidant->photo) }}"
                                   required
                            >
                        ...
                        <div class="mb-6">
                            ...
                            <textarea class="border border-gray-400 p-2 w-full rounded"
                                      ...
                                      rows="7"
                                      required
                            >{{ old('about', $confidant->about) }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea class="border border-gray-400 p-2 w-full rounded"
                                      ...
                                      rows="7"
                                      required
                            >{{ old('experiences', $confidant->experiences) }}</textarea>
